<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="bannerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="类型" align="center" prop="type" :formatter="bannerTypeFormat"/>
      <el-table-column label="目标地址" align="center" prop="address" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px">
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="目标地址" prop="address">
          <el-input v-model="form.address" placeholder="请输入目标地址" />
        </el-form-item>
  ...
  methods: {
    ...
    // 币种字典翻译
      bannerTypeFormat(row, column) {
        return this.selectDictLabel(this.bannerTypeOptions, row.type);
    },
